...
public class ComplexNumberTest {
    ...
    public void testImaginaryUnitExhibitsDefiningProperty() {
        ...
        ComplexNumber actual = new ComplexNumber(0, 1.0)
                .times(new ComplexNumber(0, 1.0));
    ...
    public void testAdditionWithPurelyRealNumbers() {
        ...
        ComplexNumber actual = new ComplexNumber(1.0, 0)
                .add(new ComplexNumber(2.0, 0));
    ...
    public void testAdditionWithRealAndImaginaryParts() {
        ...
        ComplexNumber actual = new ComplexNumber(1.0, 2.0)
                .add(new ComplexNumber(3.0, 4.0));
    ...
    public void testSubtractionWithPurelyRealNumbers() {
        ...
        ComplexNumber actual = new ComplexNumber(1.0, 0.0)
                .minus(new ComplexNumber(2.0, 0.0));
    ...
    public void testSubtractionWithRealAndImaginaryParts() {
        ...
        ComplexNumber actual = new ComplexNumber(1.0, 2.0)
                .minus(new ComplexNumber(3.0, 4.0));
    ...
    public void testMultiplicationWithRealAndImaginaryParts() {
        ...
        ComplexNumber actual = new ComplexNumber(1.0, 2.0)
                .times(new ComplexNumber(3.0, 4.0));
